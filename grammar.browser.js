...
function peg$parse(input, options) {
    ...
    var peg$startRuleFunctions = {_: peg$parse_};
    var peg$startRuleFunction = peg$parse_;
    ...
    var peg$e23 = peg$otherExpectation("n\xFAmero");
    ...
    var peg$e33 = peg$literalExpectation("console", false);
    var peg$e34 = peg$literalExpectation("log", false);
    ...
    var peg$f10 = function (decl) {
        return decl;
    };
    var peg$f11 = function (kind, name, value) {
        return {type: "VariableDeclaration", kind, name, value};
    };
    var peg$f12 = function (name, params, body) {
        return {
    ...
    var peg$f14 = function (cond, thenStmt, elsePart) {
        return {
            type: "IfStatement",
            test: cond,
            consequent: thenStmt,
    ...
    var peg$f15 = function (cond, body) {
        return {type: "WhileStatement", test: cond, body: body};
    };
    var peg$f16 = function (init, test, update, body) {
        return {
            type: "ForStatement",
            init: init || null,
            test: test || null,
    ...
    var peg$f20 = function (left, rest) {
    ...
    function peg$parseVariableDeclaration() {
        ...
        s0 = peg$currPos;
        s1 = peg$parseVarDeclNoSemicolon();
        if (s1 !== peg$FAILED) {
            s2 = peg$parse_();
            if (input.charCodeAt(peg$currPos) === 59) {
                s3 = peg$c16;
    ...
    function peg$parseVarDeclNoSemicolon() {
        var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    function peg$parseForStatement() {
        ...
        if (s1 !== peg$FAILED) {
            ...
            if (s3 !== peg$FAILED) {
                s4 = peg$parse_();
                s5 = peg$parseVarDeclNoSemicolon();
                if (s5 === peg$FAILED) {
                    s5 = peg$parseAssignmentExpression();
                }
                if (s5 === peg$FAILED) {
